...
void sudoku_game::start(){
    ...
    for(int i = 0; i < 8; i++){
        ...
        for(int j = 0; j < 8; j++){
            ...
            if(!sudoku_game::passed_in_sudoku_array[index].get_isStarting()){
                sudoku_game::highlighted_cell = {i,j};
                found = true;
                break;
            }
...
void sudoku_game::update_ui(std::vector<cell> sudoku_array, std::vector<int> highlighted_cell)
{
    ...
    //Functions containing long list of if statements for updating UI
    ...
    sudoku_game::update_cell_value(sudoku_array);

    sudoku_game::update_notes_value(sudoku_array);

    sudoku_game::update_highlight(highlighted_cell);

    sudoku_game::update_starting_squares(sudoku_array);
...
void sudoku_game::on_ToggleNoteButton_clicked()
{
...
void sudoku_game::on_eraseNotesButton_clicked()
{
    for (int i = 0; i < 81; i++){
...
void sudoku_game::on_changeValueButton_clicked()
{
...
void sudoku_game::on_mainMenuButton_clicked()
{
    //Closes this window and opens sudoku_selector instance
    this->close();
    emit mainMenu();
}
...
void sudoku_game::on_cell_Button_1_clicked()
{
    ...
    if(passed_in_sudoku_array[0].get_isStarting()){
        //If cell is starting cell, you cannot modify it
        ui->StartingSquareError->setVisible(true);

    }
    else{
        //Changing Highlight and updating UI
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);

    }
}

void sudoku_game::on_cell_Button_2_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[1].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_3_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[2].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_4_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[3].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_5_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[4].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_6_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[5].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_7_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[6].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_8_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[7].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_9_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[8].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(0,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_10_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[9].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_11_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[10].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_12_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[11].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_13_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[12].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_14_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[13].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_15_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[14].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_16_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[15].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_17_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[16].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_18_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[17].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(1,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_19_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[18].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_20_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[19].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_21_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[20].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_22_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[21].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_23_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[22].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_24_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[23].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_25_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[24].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_26_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[25].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_27_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[26].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(2,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_28_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[27].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_29_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[28].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_30_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[29].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_31_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[30].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_32_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[31].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_33_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[32].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_34_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[33].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_35_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[34].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_36_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[35].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(3,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_37_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[36].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_38_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[37].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_39_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[38].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_40_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[39].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_41_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[40].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_42_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[41].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_43_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[42].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_44_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[43].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_45_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[44].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(4,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_46_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[45].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_47_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[46].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_48_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[47].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_49_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[48].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_50_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[49].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_51_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[50].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_52_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[51].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_53_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[52].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_54_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[53].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(5,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_55_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[54].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_56_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[55].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_57_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[56].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_58_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[57].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_59_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[58].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_60_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[59].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_61_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[60].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_62_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[61].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_63_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[62].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(6,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_64_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[63].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_65_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[64].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_66_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[65].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_67_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[66].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_68_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[67].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_69_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[68].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_70_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[69].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_71_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[70].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_72_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[71].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(7,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_73_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[72].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,0);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_74_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[73].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,1);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_75_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[74].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,2);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_76_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[75].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,3);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_77_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[76].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,4);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_78_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[77].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,5);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_79_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[78].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,6);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_80_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[79].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,7);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::on_cell_Button_81_clicked()
{
    ui->InvalidMoveError->setVisible(false);
    if(passed_in_sudoku_array[80].get_isStarting()){
        ...
        ui->StartingSquareError->setVisible(false);
        sudoku_game::change_highlight(8,8);
        sudoku_game::update_ui(passed_in_sudoku_array, highlighted_cell);
    }
}

void sudoku_game::update_cell_value(std::vector<cell> sudoku_array){
...
void sudoku_game::update_notes_value(std::vector<cell> sudoku_array){
